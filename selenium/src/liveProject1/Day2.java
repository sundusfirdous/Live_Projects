...
public class Day2 {
    ...
    //Create List  - All Mobile Current Price
	 List<WebElement> currentPrice = driver.findElements(By.xpath("//span[@class = 'regular-price']"));//1 of 3
	  ...
	  /*  //Using getText() without for loop [Correct way]
	    WebElement sonyXperiaName2 = driver.findElement(By.xpath("//div[contains(@class,'pro')]/span"));//1 0f 1
	    System.out.println(sonyXperiaName2.getText());
	    Thread.sleep(3000);
	    WebElement sonyXperiaPrice2 = driver.findElement(By.xpath("//span[@class= 'price']"));//1 of 1
	    System.out.println(sonyXperiaPrice2.getText());
	    Thread.sleep(3000);
	    System.out.println((sonyXperiaName2.getText() + " ==== " + sonyXperiaPrice2.getText()));
	    driver.close();*/
